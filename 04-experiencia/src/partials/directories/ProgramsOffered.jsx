...
function ProgramasOffered(props) {
  return (
      ...
      <div className="md:flex justify-between items-center space-y-4 md:space-y-0 space-x-2">
        ...
        <div className="space-x-3 md:space-x-4">
          <div className="shrink-0 mt-1">
            <img src={NVG_logo} width="70" height="70" alt={props.program} />
          </div>
        </div>
        {/* Center */}
        <p className="text-xl font-medium">{props.program}</p>
        {/* Right side */}
        <div className="flex items-center space-x-4 md:pl-0">
          <div className="text-md text-slate-500 dark:text-slate-400 italic whitespace-nowrap">2024</div>
        </div>
      </div>
    </div>
  );
...
export default ProgramasOffered;