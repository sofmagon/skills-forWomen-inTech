            ...
            <div className="max-w-sm mx-auto w-full px-4 py-8">
              ...
              <form>
                ...
                <div className="flex items-center justify-center mt-6">
                  <Link className="btn bg-[#00BCB4] hover:bg-[#000] text-white ml-3 whitespace-nowrap" to="/">Sign Up</Link>
                </div>
              </form>
              {/* Footer */}
              <div className="pt-5 mt-6 border-t border-slate-200 dark:border-slate-700">
                <div className="text-md">
                  Have an account? <Link className="font-bold text-[#FD6F63] hover:text-[#00BCB4] dark:hover:text-indigo-400" to="/signin">Sign In</Link>
                </div>
              </div>
            </div>
          </div>
