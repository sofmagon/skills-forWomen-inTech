...
const EditCompany = () => {
  ...
  // Se ejecutará cada vez que companyData o reset cambien
  useEffect(() => {
    // Actualiza los valores del formulario cuando se obtienen los datos de la empresa
    reset(companyData);
    setValue('status', companyData.status ? 'active' : 'inactive');
  }, [companyData, reset, setValue]);
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold mb-6">Edit company information</h1>
                    ...
                    <div className="flex justify-between flex-nowrap items-center space-x-2 mb-4">
                      <form onSubmit={handleSubmit(onSubmit)} className='w-full'>
                        ...
                        <div className='mb-8'>
                          ...
                          <input name="name" id="name" className="form-input w-full px-4 py-3 text-lg" type="text" defaultValue={companyData.name}
                            {...register('name', {
                              required: {
                                value: true,
                        ...
                        <div className='mb-8'>
                          <div className="flex flex-wrap items-center">
                            <span className="block text-lg font-bold mr-6">Company status</span>

                            <div className="ml-6">
                              <label htmlFor="status-active" className="flex items-center">
                                <input type="radio" name="status" className="form-radio" value="active"
                                  {...register('status')} />
                            ...
                            <div className="ml-6">
                              <label htmlFor="status-inactive" className="flex items-center">
                                <input type="radio" name="status" className="form-radio" value="inactive"
                                  {...register('status')} />
                        ...
                        <div className='mb-8'>
                          ...
                          <textarea name="about" id="about" className='form-input w-full px-4 py-3 text-lg resize-none' defaultValue={companyData.about}
                            {...register('about', {
                              required: {
                                value: true,
                                message: 'This field is mandatory'
                        ...
                        <div className='mb-8'>
                          ...
                          <input name="site" id="site" className="form-input w-full px-4 py-3 text-lg" type="text" defaultValue={companyData.site}
                            {...register('site', {
                              required: {
                                value: true,
                                message: 'This field is mandatory'
                        ...
                        <div className='mb-8'>
                          <div className='flex gap-4 items-center'>
                            ...
                            <select id="country" className="form-select" name="country" defaultValue={companyData.country}
                              {...register('country', {
                                required: {
                                  value: true,
                                  message: 'This field is mandatory'
                        ...
                        <div className='mb-8'>
                          <div className='flex gap-4 items-center'>
                            ...
                            <select id="business_activity" className="form-select" name="business_activity" defaultValue={companyData.business_activity}
